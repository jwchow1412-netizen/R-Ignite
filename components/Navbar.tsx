...
const peopleLinks = [
  ...
  { name: "Panelists", href: "/people/panelists" },
        ...
        <nav className="hidden items-center gap-1 xl:gap-2 lg:flex">
          ...
          <div className="ml-1 flex shrink-0 items-center gap-2">
            <Button asChild variant="outline" size="icon" className="bg-[#5865F2] hover:bg-[#4752C4] border-none text-white h-9 w-9">
              <Link href={user ? "https://discord.gg/49nQjN38zS" : "/login"} target={user ? "_blank" : undefined} rel={user ? "noopener noreferrer" : undefined}>
